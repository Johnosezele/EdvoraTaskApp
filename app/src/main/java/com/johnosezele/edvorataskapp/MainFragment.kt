...
import com.johnosezele.edvorataskapp.PaintView.Companion.canvas
import com.johnosezele.edvorataskapp.PaintView.Companion.currentBrushColor
import com.johnosezele.edvorataskapp.PaintView.Companion.currentShape
import com.johnosezele.edvorataskapp.databinding.MainFragmentBinding
    ...
    private fun setListeners() {
        ...
        binding.clearAll.setOnClickListener {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                vibration.vibrate(VibrationEffect.createPredefined(EFFECT_TICK))
            } else {
                vibration.vibrate(createOneShot(50, 1))
            }
